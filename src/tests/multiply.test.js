...
describe("tests for multiply operation", () => {
	const calculateMultiply = (...values) => getOperationResult("multiply", ...values);
	...
	it("should handle decimal numbers", () => {
		expect(calculateMultiply(0.12313132, 0.3737373737)).toBeCloseTo(0.12313132 * 0.3737373737, ROUNDING_PRECISION);
		expect(calculateMultiply(0.21312322, 0.2342342424)).toBeCloseTo(0.21312322 * 0.2342342424, ROUNDING_PRECISION);
		expect(calculateMultiply(0.1, 0.2)).toBeCloseTo(0.1 * 0.2, ROUNDING_PRECISION);
	});
